...
// DESCRIPTION   : This header file is Net.h of reliableUDP from Reliability and Flo
// WriteFile function called from int ReceivePacket(unsigned char data[], int size) is added for this project
...
// Create another constant called PacketSizeHack in Net.h
#define PACKETSIZEHACK    384

// Add #pragma warning(suppress : 4996) just above the line with the sscanf error
...
#include <unistd.h>
	...
	// NO_ERROR) – this needs to return TRUE for success, but returns FALSE because of the != check. Change it to == instead.
	...
	*/
	...
	public:
		...
		const char kFileName[kBlockSize] = { 0 };
		...
		int ReceivePacket(unsigned char data[], int size)
		{
			...
			//**** A1
			WriteFile(data, packet_sequence, packet_ack, kFileName);			
			//****
	...
	protected:
		...
		// Write sequence, ack, ack_bit of elements of header
